...
use DuncanMcClean\Cargo\Exceptions\CartNotFound;
...
class CartRepository implements RepositoryContract
{
    ...
    {
        return vsprintf('%s%s', [
            config('statamic.cargo.carts.cookie_name'),
    ...
    {
        return [
            Cart::class => \DuncanMcClean\Cargo\Cart\Cart::class,
            QueryBuilder::class => \DuncanMcClean\Cargo\Stache\Query\CartQueryBuilder::class,
        ];
    }
