...
export default {
    ...
    watch: {
        saving(saving) {
            this.$progress.loading(`${this.publishContainer}-discount-publish-form`, saving);
        },
            ...
            this.$axios[this.method](this.actions.save, payload)
                .then((response) => {
                    ...
                    if (!response.data.saved) {
                        return this.$toast.error(__(`Couldn't save discount`));
                    }
        ...
        runAfterSaveHook(response) {
            ...
            Statamic.$hooks
                ...
                .then(() => {
                    ...
                    // If the user has opted to create another discount, redirect them to create page.
